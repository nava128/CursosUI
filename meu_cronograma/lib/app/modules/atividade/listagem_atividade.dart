...
class ListagemAtividade extends StatelessWidget {
  ...
  final AtividadeStore _controller = Modular.get<AtividadeStore>();

  ListagemAtividade({Key? key, required this.curso}) : super(key: key);
          ...
          return Slidable(
            ...
            child: Observer(
              builder: (BuildContext context) => CheckboxListTile(
                ...
                onChanged: (feito) =>
                    _controller.updateAtividadeStatus(atividade, feito!),
              ),
            ),
